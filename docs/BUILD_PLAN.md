# Contact Forge — Architecture

This document is the authoritative reference for the data model, matching/reconciliation
design, JXA bridge contract, and desync-alert workflow. Read it before making
non-trivial changes — the matching/reconciliation design (§4) is the core of the plugin.
...
emails:
  ...
  - { label: 'home', value: 'john.personal@example.com' }
phones:
  - { label: 'mobile', value: '+34600111222' }
contact_note: 'Met at a conference in 2025' # maps to Contacts "note" field
...
---
Freeform notes about John here. (NOT synced unless it's the contact_note field.)
```
...
## 11. Obsidian community-plugin submission checklist
